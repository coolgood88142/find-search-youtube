(function(){/*
   ...
   */
   ...
   "CSS1Compat"==ea.compatMode?ea.documentElement:ea.body;var ma=(new Gc(U.clientWidth,U.clientHeight)).round()}catch(va){ma=new Gc(-12245933,-12245933)}ea=ma;ma={};U=new Kd;B.SVGElement&&B.document.createElementNS&&U.set(0);x=Nc();x["allow-top-navigation-by-user-activation"]&&U.set(1);x["allow-popups-to-escape-sandbox"]&&U.set(2);B.crypto&&B.crypto.subtle&&U.set(3);B.TextDecoder&&B.TextEncoder&&U.set(4);U=Ld(U);ma.bc=U;ma.bih=ea.height;ma.biw=ea.width;ma.brdim=q.join();b=b.i;ea="Ba";Md.Ba&&Md.hasOwnProperty(ea)?
   ea=Md.Ba:(U=new Md,Md.Ba=U,Md.hasOwnProperty(ea),ea=U);b=(ma.vis=ea.A(Qc.flag,Qc.defaultValue)&&b.prerendering?3:{visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[b.visibilityState||b.webkitVisibilityState||b.mozVisibilityState||""]||0,ma.wgl=!!Fc.WebGLRenderingContext,ma);c=d.call(c,e,b);c.ca_type="image";a&&(c.bid=a);return c}
